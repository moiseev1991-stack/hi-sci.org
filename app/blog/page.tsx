...
export const metadata: Metadata = {
  title: 'Blog – Recenzje, Bonusy i Strategie',
  description: 'Artykuły o kasynach online dla polskich graczy — recenzje operatorów, porównania bonusów, strategie i porady.',
    ...
    <div className="archive blog max-w-6xl mx-auto px-4 sm:px-6 py-10">
      ...
      <header className="page-header mb-10">
        <h1 className="page-title font-heading text-4xl font-bold text-[var(--text)]">
          Blog – Recenzje, Bonusy i Strategie
        </h1>
      </header>
