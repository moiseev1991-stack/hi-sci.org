...
export const metadata: Metadata = {
  ...
  description: 'Polityka prywatności portalu Hi-Sci. Informacje o przetwarzaniu danych osobowych zgodnie z RODO.',
  ...
  return (
    <div className="max-w-3xl mx-auto px-4 sm:px-6 py-10">
      ...
      <div className="prose prose-lg max-w-none prose-headings:font-heading">
        ...
        <p>
          Administratorem danych osobowych zbieranych za pośrednictwem serwisu {siteConfig.url} jest redakcja Hi-Sci. Serwis jest przeznaczony dla użytkowników z Polski i działa zgodnie z przepisami Rozporządzenia Parlamentu Europejskiego i Rady (UE) 2016/679 z dnia 27 kwietnia 2016 r. (RODO).
        </p>
