      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 pt-10 pb-12">
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-10">
          ...
          <div className="sm:col-span-1">
            <div className="text-2xl font-bold font-heading text-[var(--accent-light)] mb-3">Hi-Sci</div>
            <p className="text-sm text-gray-400 leading-relaxed mb-4">
              Portal o kasynach online dla polskich graczy — recenzje, bonusy i analityczne porównania licencjonowanych operatorów.
            </p>
      ...
      <div className="border-t border-white/10 py-4 px-4 sm:px-6">
        <div className="max-w-6xl mx-auto flex flex-col sm:flex-row justify-between items-center gap-2 text-xs text-gray-600">
          ...
          <span className="site-info">
            Treści hazardowe tylko dla osób pełnoletnich (18+). Hazard może uzależniać. Graj odpowiedzialnie. &nbsp;·&nbsp;
